...
export async function buildCardLab() {
  ...
  const manifest = { revision, cards: ['dodge_counter_boss', 'rhythm_timing', 'drag_collect_grid', 'sequence_synthesis', 'turn_based_skill_battle', 'side_scrolling_brawler', 'survivor_horde', 'reaction_pick', 'energy_balance'], releaseEligible: false,
