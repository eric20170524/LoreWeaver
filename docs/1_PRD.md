...
- **P0 (已完成):** 部门筹备从主干走到节点 1–12。节点 2、4、5、7、10 保留原卡。人审已确认，阶段进入资产确认。
- **P0 (已完成):** 运行就绪。节点 5 补了远射运行时证据。无关卡音频文件时用每关不同的合成背景。没有做风格板，也没有把缺失的构建门写成通过。
...
- 不把 Phaser 战斗文案迁到 `t()`。
- 不把部门筹备的自动确认打开。人不确认，部门就停在 `ready_for_review`。
- 不借筹备把节点 2、4、5、7、10 改成 `survivor_horde`。
