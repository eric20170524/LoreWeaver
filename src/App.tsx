...
export default function App() {
  const [themeMode, setThemeMode] = useState<"light" | "dark">(() => {
    ...
    return "dark"; // Default to dark for premium fantasy aesthetic
  });
  ...
  return (
    <div className="lw-app min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans flex flex-col antialiased selection:bg-emerald-500 selection:text-slate-950 transition-colors duration-250">
      ...
      <header className="border-b border-slate-200 dark:border-slate-900 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md sticky top-0 z-50 px-4 md:px-8 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4 transition-colors duration-250">
        ...
        <div className="flex flex-col sm:flex-row gap-2 max-w-xl w-full">
          <div className="relative flex-1">
            ...
            />
            <Sparkles className="absolute left-3 top-2.5 w-4.5 h-4.5 text-slate-400 dark:text-slate-600" />
          </div>
      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-4 md:px-8 py-6 grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="bg-white/90 dark:bg-slate-900/60 p-5 rounded-2xl border border-slate-200 dark:border-slate-900/90 flex flex-col gap-4 shadow-xl">
            ...
            <div className="flex flex-col gap-2.5 my-0.5 relative">
              ...
              {copy.stages.map((stage, id) => {
                ...
                let dotClass = "border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-400 dark:text-slate-600";
            ...
            {currentJob && (
              <div className="border-t border-slate-200 dark:border-slate-900 pt-3 flex flex-col gap-1.5">
                ...
                <div className="text-3xs text-slate-600 dark:text-slate-400 font-sans italic line-clamp-1">{currentJob.progress}</div>
              </div>
            )}
          </div>
        ...
        <div className="lg:col-span-8 bg-white/70 dark:bg-slate-900/30 rounded-xl border border-slate-200 dark:border-slate-900/80 p-4 md:p-6 overflow-hidden min-h-[70vh] flex flex-col gap-6 transition-colors duration-250">
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded text-xs font-semibold font-display tracking-wide whitespace-nowrap transition flex items-center gap-2 cursor-pointer shrink-0 border-b-2 ${
                    activeTab === tab.id
                      ? "border-emerald-500 text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/5"
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <AnimatePresence mode="wait">
                ...
                >
                  {gameSpec ? (
                    <div className="flex flex-col items-center gap-6 w-full relative">
                      ...
                      <div className="relative w-full max-w-[min(360px,78vw,calc((100vh-260px)*9/16))] aspect-[9/16] bg-slate-200 dark:bg-slate-950 rounded-[40px] p-2.5 shadow-2xl ring-[14px] ring-slate-300/90 dark:ring-slate-900/90 flex flex-col border border-slate-300 dark:border-slate-800/80 overflow-hidden shadow-emerald-500/5 hover:scale-[1.01] transition-transform duration-300">
                      ...
                      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white/80 dark:bg-slate-900/40 px-5 py-4 rounded-xl border border-slate-200 dark:border-slate-900 w-full max-w-xl text-xs shadow-lg backdrop-blur-sm">
                        ...
                        <div className="flex items-center gap-3.5 text-2xs font-mono bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-900/60 px-4 py-2 rounded-lg text-slate-600 dark:text-slate-400">
              ...
              {activeTab === "prd" && (
                ...
                >
                  {prdSpec ? (
                    <div className="bg-white/80 dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-900 p-6 space-y-6 max-h-[calc(70vh-100px)] overflow-y-auto scrollbar-thin">
                          ...
                          {isPrdEditing ? (
                            <>
                              <button
                                ...
                                className="px-3 py-1.5 rounded bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 text-3xs font-bold flex items-center gap-1.5"
                              >
                            ...
                            <button
                              ...
                              className="px-3 py-1.5 rounded bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:border-emerald-500/40 hover:text-emerald-600 dark:hover:text-emerald-300 text-3xs font-bold flex items-center gap-1.5"
                            >
              ...
              {activeTab === "gameplay" && (
                ...
                >
                  {gameSpec ? (
                    <div className="bg-white/80 dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-900 p-6 space-y-5 max-h-[calc(70vh-100px)] overflow-y-auto scrollbar-thin">
                          ...
                          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className="px-3 py-1.5 rounded bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 text-3xs font-bold"
                              >
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-3">
                                <label className="flex flex-col gap-1 text-3xs text-slate-500 uppercase font-mono">
                                  ...
                                  <select
                                    ...
                                    className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded px-2 py-2 text-slate-800 dark:text-slate-200 normal-case"
                                  >
                                      ...
                                      <label
                                        ...
                                        className={`px-2.5 py-1.5 rounded border text-3xs cursor-pointer ${
                                          checked
                                            ...
                                            : "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 text-slate-600 dark:text-slate-500"
                                        }`}
                                      >
                                        <input
                                          type="checkbox"
                ...
                >
                  {gameSpec ? (
                    <div className="bg-white/80 dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-900 p-6 space-y-3">
                      ...
                      <pre className="bg-white dark:bg-slate-950 p-4 rounded-lg font-mono text-2xs text-slate-600 dark:text-slate-400 max-h-[calc(70vh-180px)] overflow-y-auto border border-slate-200 dark:border-slate-900 leading-relaxed">
            ...
            >
              <div className="flex items-center justify-between gap-3 border-b border-slate-200 dark:border-slate-800 px-4 py-3">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-3xs font-bold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:border-slate-400 dark:hover:border-slate-700 transition"
                >
                  {copy.logs.collapse}
                </button>
              </div>
